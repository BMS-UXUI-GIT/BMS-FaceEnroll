...
abstract class AppPages {
  ...
  static final pages = <GetPage>[
    ...
    GetPage(name: Routes.home, page: () => const ShellView(), binding: ShellBinding()),
    GetPage(name: Routes.settings, page: () => const SettingsView(), binding: SettingsBinding()),
    GetPage(name: Routes.faceScan, page: () => const FaceScanView(), binding: FaceScanBinding()),
    GetPage(name: Routes.registration, page: () => const RegistrationView(), binding: RegistrationBinding()),
    GetPage(name: Routes.setPin, page: () => const SetPinView(), binding: SetPinBinding()),
    GetPage(name: Routes.enterPin, page: () => const EnterPinView(), binding: EnterPinBinding()),
  ];
}
