// แคปแถวกราฟหน้ารายแผนก (เปรียบเทียบการมาทำงาน + โดนัทมาสาย) — before/after ของ changelog legend
// รันจาก root: node presentation/capture-deptchart.mjs <suffix "" | "-before">
...
await page.locator('aside').getByRole('button', { name: 'รายแผนก', exact: true }).first().click()
await wait(2200)
await page.screenshot({ path: `${OUT}dept-chart${SUF}.png` })
console.log('✓ dept-chart' + SUF)
await browser.close()
