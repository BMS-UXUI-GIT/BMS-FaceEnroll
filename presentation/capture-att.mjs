// แคปหน้าการลงเวลาของพนักงาน (admin) — before/after ของ changelog คอลัมน์ GPS
// รันจาก root: node presentation/capture-att.mjs <suffix "" | "-before">
...
await page.locator('aside').getByRole('button', { name: 'การลงเวลาของพนักงาน', exact: true }).first().click()
await wait(2000)
await page.screenshot({ path: `${OUT}attendance-gps${SUF}.png` })
console.log('✓ attendance-gps' + SUF)
await browser.close()
